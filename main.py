...
# 환경변수
# =========================
REACT_APP_KIS_APP_KEY = os.getenv("REACT_APP_KIS_APP_KEY")
REACT_APP_KIS_APP_SECRET = os.getenv("REACT_APP_KIS_APP_SECRET")
REACT_APP_KIS_SECRET_KEY = os.getenv("REACT_APP_KIS_SECRET_KEY")
...
def get_approval_key():
    ...
    body = {"appkey": REACT_APP_KIS_APP_KEY, "secretkey": REACT_APP_KIS_SECRET_KEY}
...
def get_access_token():
    ...
    body = {"grant_type": "client_credentials", "appkey": REACT_APP_KIS_APP_KEY, "appsecret": REACT_APP_KIS_APP_SECRET}
    res = requests.post(url, json=body)
    if res.status_code != 200:
...
def get_price(ticker: str):
    ...
    headers = {
        ...
        "appkey": REACT_APP_KIS_APP_KEY,
        "appsecret": REACT_APP_KIS_APP_SECRET,
        "tr_id": "FHKST01010100"
    }
    ...
    while True:
        try:
            ...
            headers = {
                ...
                "appkey": REACT_APP_KIS_APP_KEY,
                "secretkey": REACT_APP_KIS_SECRET_KEY,
                "custtype": "P"
            }
